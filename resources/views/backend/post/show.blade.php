...
<div class="card">
    <div class="card-body">
        <h3 class="text-center">
            <span class="text-success">Post Details</span>
        </h3>
        <p class="card-text">
            ...
            <table class="table table-striped table-responsive">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="pb-3"><img class="w-100"
                                    src="{{asset('storage/backend/images/'.$value->thumbnail_path)}}" alt=""></div>
                            Status : <span
                                class="text-center {{$value->status == 'trashed' || $value->status == 'unpublished' ? 'text-danger':'text-success'}}">{{$value->status == 'trashed' ? 'Trushed':($value->status == 'unpublised' ? 'Unpublised' : 'Published')}}</span>
                        </td>
                        <td>
                            <table>
                                <tr>
