            ...
            <div class="col-md-3">
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" style="height: 95px"
                                src="{{asset('storage/backend/images/'.$user->photo)}}" alt="{{$user->photo}}">
                        </div>
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>Posts</b> <a class="float-right">{{optional($user->posts)->count()}}</a>
                            </li>
                            <li class="list-group-item">
                        ...
                        <a href="#settings" class="btn btn-primary btn-block" data-toggle="tab"><b>Update Now</b></a>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">{{optional($user->about)->location}}</p>
                        ...
                        <p class="text-muted">{{optional($user->about)->description}}</p>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Comments</a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="settings">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data"
                                    action="{{route('user.profile.update',$user->id)}}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputName2" name="phone_number"
                                                value="{{$user->phone_number}}" placeholder="8801********">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row ml-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="radio" id="admin" name="role" @if($user->role =='admin' )
                                            checked
                                            @endif class="form-check-input" value="admin">
                                            <label for="admin">Admin</label>
                                            <br>

                                            <input type="radio" id="author" @if($user->role =='author' ) checked @endif
                                            name="role" class="form-check-input" value="author">
                                            <label for="author">Author</label>
                                            <br>

                                            <input type="radio" id="contributor" name="role" class="form-check-input"
                                                value="contributor" @if($user->role =='contributor' ) checked @endif>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="education" id="inputExperience"
                                                placeholder="Experience">{{optional($user->about)->education}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="skills" id="inputSkills"
                                                value="{{optional($user->about)->skills}}" placeholder="Skills">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="location" class="form-control" id="location"
                                                value="{{optional($user->about)->location}}" placeholder="Address">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" rows="6" cols="30" name="description"
                                                id="description"
                                                placeholder="Notes">{{optional($user->about)->description}}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
