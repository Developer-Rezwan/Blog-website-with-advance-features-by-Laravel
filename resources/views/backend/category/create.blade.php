  ...
  <section class="container col-6 my-5">
    <div class="card">
        ...
        @if ($errors->any())
            ...
            <input type="text" class="form-control" name="name" id="category" placeholder="Name" value="{{old('name')}}">
        </div>
        <div class="form-group">
            <label for="slug">Slug</label>
            <input type="text" disabled class="form-control" name="slug" id="slug" value="{{old('slug')}}" placeholder="category-slug">
        </div>
        <div class="form-group">
